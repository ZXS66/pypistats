...
function renderMetadata(data) {
	...
	// sample data: 
	// {"data":{"last_day":10720429,"last_month":259462935,"last_week":62910252},"package":"python-dotenv","type":"recent_downloads"}
	const container = getMetaContainer();
	if (!container) {
		return;
	}
...
const queryDownloadStatsMeta = async (packageId) => {
	...
	const url = `https://johnzhu.cn/cors-proxy/https://pypistats.org/api/packages/${packageId}/recent`;
